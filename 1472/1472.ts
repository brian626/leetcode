...
class BrowserHistory {
    ...
    visit(url: string): void {
        this.history = this.history.slice(0, this.currentUrl + 1)
        this.history.push(url)
        this.currentUrl++
    }

    back(steps: number): string {
        steps = Math.min(steps, this.currentUrl)
    ...
    forward(steps: number): string {
        steps = Math.min(steps, this.history.length - this.currentUrl - 1)
        this.currentUrl += steps
...
let browserHistory: BrowserHistory = new BrowserHistory("leetcode.com");
browserHistory.visit("google.com");       // You are in "leetcode.com". Visit "google.com"
browserHistory.visit("facebook.com");     // You are in "google.com". Visit "facebook.com"
browserHistory.visit("youtube.com");      // You are in "facebook.com". Visit "youtube.com"
