...
// referred to by numbers 0 and 1 respectively. All students stand in a queue. Each student either prefers square or circular sandwiches.
...
// of the i​​​​​​th sandwich in the stack (i = 0 is the top of the stack) and students[j] is the
...
function countStudents(students: number[], sandwiches: number[]): number {
    let numSadStudents = 0

    while (sandwiches.length > 0 && numSadStudents != sandwiches.length) {
