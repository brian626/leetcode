...
class ParkingSystem {
    ...
    addCar(carType: number): boolean {
        switch(carType) {
            case 1:
                if (this.numBig > 0) { this.numBig--; return true; }
                else                 { return false; }
            case 2:
                if (this.numMedium > 0) { this.numMedium--; return true; }
                else                    { return false; }
            case 3:
                if (this.numSmall > 0) { this.numSmall--; return true; }
                else                 { return false; }
        }
    }
